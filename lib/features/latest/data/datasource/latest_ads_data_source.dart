...
abstract class LatestAdsDataSource {
  Future<List<ProductModel>> getLatestAds(PaginationFilter filter);
}

class LatestAdsDataSourceImpl extends LatestAdsDataSource {
  final Dio dio;

  LatestAdsDataSourceImpl({required this.dio});

  @override
  Future<List<ProductModel>> getLatestAds(filter) async {
 ...
 Map<String, dynamic> queryParameters = {
    ...
    var response = await dio.get(BASEURL + '/advertisement/filter/latest', queryParameters: queryParameters);
