...
class Event extends Equatable {
  ...
  const Event({required this.id,this.name, this.description, this.logo,this.datetime, this.date, this.time, this.preparing, this.address, this.ago, this.periods, this.appliedStatus = 'undefined', this.nationalID = ''});
