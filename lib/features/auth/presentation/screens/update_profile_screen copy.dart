...
import 'package:sagr/features/auth/presentation/widgets/multi_select_dropdown.dart';
  ...
  void _loadUserData() async {
    ...
    try {
      ...
      print("😋");
        ...
        if (userData!['selectedJob'] != null) {
          // Set job if stored
          var jobData = userData!['selectedJob'];
          // _accountController.selectedJob = JobModel(
          //   id: jobData['id'],
          //   name: jobData['name'],
          // );
        }
        ...
        if (userData!['selectedMaritalStatus'] != null) {
          ...
          // _accountController.selectedMaritalStatus = MaritalStatusModel(
          //   id: maritalStatusData['id'],
