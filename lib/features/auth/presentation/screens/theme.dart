...
class LightTheme extends AppTheme {
  LightTheme({
    ...
    Color backArrowColor = const Color.fromARGB(255, 0, 0, 0),
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = const Color.fromARGB(255, 0, 0, 0),
    ...
    Color verticalBarColor = const Color.fromARGB(255, 0, 0, 0),
