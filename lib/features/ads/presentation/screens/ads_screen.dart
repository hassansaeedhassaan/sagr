...
return Container(
  ...
  child: PremiumAdCard(data: AdCardData(
        companyName: eventController.ads.elementAt(index).name.toString(),
        title: eventController.ads.elementAt(index).name.toString(),
        description: eventController.ads.elementAt(index).description.toString(),
        dateTime: DateTime(2026, 2, 14, 10, 30),
        imageUrl: "$HOSTURL${eventController.ads.elementAt(index).logo}",
        ...
        // fullArticle: _sampleArticle,
              ...
              //     description:
              //         'Explore our newest lineup of all-electric trucks and SUVs, designed for those who refuse to compromise between performance and sustainability.',
              //     dateTime: DateTime(2026, 2, 14, 10, 30),
              ...
              //   );
                ...
                // Card WITHOUT event label
              //  return PremiumAdCard(
              //     companyName: 'Aesop',
              //     title: 'A New Chapter in Botanical Skincare',
              //     description:
              //         'Discover plant-based formulations crafted with meticulous care for discerning individuals worldwide.',
