...
class DashboardProfileUpdateScreen extends StatelessWidget {
  final _formKey = GlobalKey<FormState>();

  final AccountController _controller;

  DashboardProfileUpdateScreen(this._controller, {Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CustomTextFormField(
                  ...
                  initialValue: _controller.authenticatedUser?['name'] ?? "",
