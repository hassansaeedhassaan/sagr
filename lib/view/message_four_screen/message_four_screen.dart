...
class MessageFourScreen extends StatelessWidget {
  MessageFourScreen({Key? key})
      : super(
          key: key,
        );

 final TextEditingController messageTwoEditTextController = TextEditingController();

final  TextEditingController messageEditTextController = TextEditingController();
 ...
 final GlobalKey<NavigatorState> navigatorKey = GlobalKey();
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildMessageTwoEditText(context),
                      SizedBox(height: 8.v),
                      Text(
                        "12 August 2022 At 4:45 PM",
                        style: theme.textTheme.bodySmall,
  ...
  /// Section Widget
  Widget _buildMessageTwoEditText(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(right: 108.h),
      child: CustomTextFormField(
        controller: messageTwoEditTextController,
